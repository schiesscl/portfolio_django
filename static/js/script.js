...
$(function() {
    ...
    const aboutParagraphs = [
        gettext("Land surveying Technician and Full Stack Java, JavaScript & Python developer with a solid base in web technologies such as <strong>HTML, CSS and JavaScript. Experienced in Bootstrap, MySQL, JQuery, Java, Spring Boot Node.js, express.js PostgreSQL, Python, React, Django, SQLite and Docker.</strong>"),
